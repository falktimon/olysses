...
2.  **Download a Model:** You need to have a model available for the application to use. You can configure which model to use in the app's preferences. To download a model (e.g., `llama3`), run:
    ```bash
    ollama pull llama3
    ```
